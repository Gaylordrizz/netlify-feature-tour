...
class SupabaseTableHelpers {
  ...
  static Future<void> updateUserChatRoom({
    ...
    if (lastMessageAt != null)
      data['last_message_at'] = lastMessageAt.toIso8601String();
  ...
  static Future<void> updateSubscription({
    ...
    if (currentPeriodStart != null)
      data['current_period_start'] = currentPeriodStart.toIso8601String();
    if (currentPeriodEnd != null)
      data['current_period_end'] = currentPeriodEnd.toIso8601String();
  ...
  static Future<List<Map<String, dynamic>>> getMessagesForCommunity(
    String communityId, {
    int limit = 50,
  }) async {
  ...
  static Future<void> updateStoreStats({
    ...
    await repo.updateBy(SupabaseTables.storeStats, 'store_id', storeId, data);
  }
  ...
  static Future<void> addUserSavedProduct({
    ...
    await repo.upsert(SupabaseTables.userSavedProducts, {
      'user_id': userId,
      'product_id': productId,
  ...
  static Future<void> addUserSavedStore({
    ...
    await repo.upsert(SupabaseTables.userSavedStores, {
      'user_id': userId,
      'store_id': storeId,
      'saved_at': (savedAt ?? DateTime.now()).toIso8601String(),
  ...
  static Future<void> deleteOrder({required String orderId}) async {
